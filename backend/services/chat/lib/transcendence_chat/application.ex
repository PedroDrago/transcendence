defmodule TranscendenceChat.Application do
  ...
  def start(_type, _args) do
    children = [
      TranscendenceChatWeb.Telemetry,
      TranscendenceChat.Repo,
      {Ecto.Migrator,
    ...
    opts = [strategy: :one_for_one, name: TranscendenceChat.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    TranscendenceChatWeb.Endpoint.config_change(changed, removed)
    :ok
  end
