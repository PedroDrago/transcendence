...
config :transcendence_chat, TranscendenceChatWeb.Endpoint,
  ...
  secret_key_base: "+0AJ9iK9Q8/gIRcYT67o3675sOv90Ts6EZ5qe2w+0Gns5AYzHpV7x2/7MTDC/cc1",
  server: false

# In test we don't send emails
config :transcendence_chat, TranscendenceChat.Mailer, adapter: Swoosh.Adapters.Test
