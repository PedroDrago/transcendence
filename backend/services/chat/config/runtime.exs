...
#
#     PHX_SERVER=true bin/transcendence_chat start
#
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/transcendence_chat/transcendence_chat.db
      """
  ...
  #
  #     config :transcendence_chat, TranscendenceChat.Mailer,
