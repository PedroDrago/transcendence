...
USER_SERVICE_URL=${USER_SERVICE_URL}
R2_ACCESS_KEY_ID=${R2_ACCESS_KEY_ID:-$MINIO_ACCESS_KEY_ID}
R2_SECRET_ACCESS_KEY=${R2_SECRET_ACCESS_KEY:-$MINIO_SECRET_ACCESS_KEY}
R2_ENDPOINT=${R2_ENDPOINT:-$MINIO_ENDPOINT}
R2_BUCKET=${R2_BUCKET:-$MINIO_BUCKET}
SERVICE_NAME=posts
EOF
